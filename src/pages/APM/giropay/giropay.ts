...
export const giropayWord = "giropay is a payment method in Germany."

export const renderGiropayBtn = (
    ...
    if (window.paypal) {
        ...
        window.paypal.Marks({
            fundingSource: window.paypal.FUNDING.GIROPAY,
